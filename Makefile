...
PROJECT_NAME = DTCD-ExtensionElectricalSchemePrimitives
PLUGIN_NAME = ExtensionElectricalSchemePrimitives
...
DTCD_SDK = DTCD-SDK
DTCD_SDK_URL = $(DEV_STORAGE)/$(DTCD_SDK)/$(DTCD_SDK)-0.1.2-develop-0128.tar.gz
